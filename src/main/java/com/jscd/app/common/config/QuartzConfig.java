...
import com.jscd.app.lecture.lstRegist.service.LstregistInProcessJob;
...
public class QuartzConfig {
    ...
    @Bean
    public JobDetailFactoryBean classInProcessJob() {
        JobDetailFactoryBean jobDetailFactory = new JobDetailFactoryBean();
        jobDetailFactory.setJobClass(LstregistInProcessJob.class);
        jobDetailFactory.setDurability(true);
        return jobDetailFactory;
    }
    ...
    @Bean(name = "classInProcessJobTrigger")
    public CronTriggerFactoryBean classInProcessJobTrigger(JobDetail classInProcessJob) {
        CronTriggerFactoryBean trigger = new CronTriggerFactoryBean();
        trigger.setJobDetail(classInProcessJob);
        trigger.setCronExpression("0 0 0 * * ?");
        return trigger;
    }
    ...
    public SchedulerFactoryBean schedulerFactory(
            ...
            @Qualifier("classInProcessJobTrigger") Trigger classInProcessJobTrigger) {
        ...
        schedulerFactory.setTriggers(lockerEmailJobTrigger, lockerDeleteJobTrigger, classInProcessJobTrigger);
