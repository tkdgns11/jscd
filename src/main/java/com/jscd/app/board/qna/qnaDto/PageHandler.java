...
public class PageHandler {
    ...
    private int totalCnt; // 게시물의 총 갯수 page
    private int totalPage; // 전체 페이지의 갯수 maxPage
    private int beginPage; // 화면에 보여줄 첫 페이지 BeginPage
    private int endPage; // 화면에 보여줄 마지막 페이지 endPage
