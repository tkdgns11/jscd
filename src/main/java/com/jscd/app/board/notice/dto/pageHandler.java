...
public class pageHandler {
    ...
    public pageHandler(int totalCnt, Integer page) {
        this(totalCnt, new SearchCon(page, 10));
    }

    public pageHandler(int totalCnt, Integer page, Integer pageSize) {
        this(totalCnt, new SearchCon(page, pageSize));
    }

    public pageHandler(int totalCnt, SearchCon sc) {
    ...
    public SearchCon getSc() {
        return sc;
    }

    public void setSc(SearchCon sc) {
        this.sc = sc;
    }
