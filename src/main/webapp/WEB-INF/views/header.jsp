...
<div>
    ...
    <div>
        ...
        <div>
            <input type="button" value="${loginStatus}" class="registeBtn" onClick="location.href='<c:url value='${loginPath}'/>'">
            <input type="button" value="${memberStatus}" class="modifyBtn" onClick="location.href='<c:url value='${memberPath}'/>'">
        </div>
