...
<form id="form">
    <div id="detailHd">
        ...
        <div id="wrapCon">
            <textarea id="content"
                      name="content"  style=" padding:10px;";  ${mode eq 'new' ? '' : 'readonly=readonly'}>${allqnaList.content}</textarea>
...
<section id="cmmtBox" style="${mode == 'new' ? 'display: none;' : ''}">
    ...
    <div id="cmmtContent">
        ...
        <textarea id="cmtContentRegi" name="cmtContent" rows="1" style="resize: none; height: 50px;" placeholder="답변을 입력하세요."></textarea><br/>
    </div>
    <div id="cmmtBtn">
        <%-- 취소버튼 만들었음 --%>
