                                ...
                                <div>
                                    ...
                                    <span id="user_info_id">&nbsp;&nbsp;
                                        <i class="fa-solid fa-user-pen fa-xs" style="color: #afb1b6;"></i>
                                            ${stdNoticeDto.writer}</span>
                                </div>
                                <span id="hit_num"><i class="fa-regular fa-eye" style="color: #afb1b6;"></i> ${stdNoticeDto.viewCnt}</span>
                            </div>
                        </div>
                    </c:forEach>
                </div>
                <div id="board_paging">
                    ...
                    <c:if test="${totalCnt!=null && totalCnt!=0}">
                        <c:if test="${ph.showPrev}">
                            <a class="page" href="<c:url value="/board/userStd/list${ph.sc.getQueryString(ph.beginPage-1)}"/>">
                        ...
                        <c:if test="${ph.showNext}">
                            <a class="page" href="<c:url value="/board/userStd/list${ph.sc.getQueryString(ph.endPage+1)}"/>">
