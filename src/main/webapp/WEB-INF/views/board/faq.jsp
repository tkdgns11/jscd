            ...
            <div class="innerbox">
                ...
                <div id="blue1">
                    ...
                    <div id="blue1bd">한 달 동안 배운 내용을 테스트합니다.<br>
                        ...
                        한 달 동안 열심히 (하루 14시간 이상) 하셨으면 대부분 통과할 수준의 문제들입니다.
                    </div>
                </div>
                <div id="blue2">
                    <div id="blue2hd">Q. 국비와 다른 점이 무엇인가요?</div>
                    <div id="blue2bd">강의 퀄리티, 학습 방법 및 관리, 상담 퀄리티에서 많은 차이를 보입니다.<br><br>
                        학습 환경 및 시설 또한 저희 학원이 우세합니다.<br><br>
                        국비를 경험해 보지 못하신 분들은 검색해 보시거나 며칠이라도 다녀오실 것을 권해드립니다.
                    </div>
                </div>
            </div>
